...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        % \resumeItem{Led development of database-wide suport for customer-managed encryption keys, whereby user data is encrypted at rest by a customer-controlled key.}
