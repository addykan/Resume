...
\rhs{
    ...
    {Migrated a critical portion of WhatsApp Business backend to Meta's serverless infrastructure}
    {Greatly reduced development overhead, improving dev velocity and simplifying a heavily-used messaging pipeline}
    {Consolidated team's infra services and eliminated dependencies on external teams for deployment/maintenance}
