...
\rhs{
    ...
    {Built another tool to visualize dependency graph for datasets used by data science team}
    {Improved sustainability of data science area's growth objectives for 2023}
    ...
    {Reduced development timelines on this service from weeks to hours}
    ...
    {Implemented the Live Sequence Protocol, a custom network protocol that extends UDP}
    ...
    \subsectionbreak{}
    \work{Bustub}{15-445 Database Systems}{Spring 2023}
    ...
    \subsectionbreak{}
    \work{CMUD}{15-440 Distributed Systems}{Fall 2022}
