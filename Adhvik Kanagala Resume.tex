...
\lhs{
    ...
    \skills{Languages}{Python (Proficient)}{Flutter/Dart (Intermediate)}{R (Beginner/Intermediate)}{MATLAB (Beginner)}
...
\rhs{
    ...
    \work{15-112 Fund. of Programming and Computer Science}{Teaching Assistant}{Feb 2021 - Present}{Work with a 50-member staff as well as 2 professors to deliver a introduction to the principles of computer science, taught in Python}{Teach group sessions of 5-100 students, individually tutor struggling students, grade assignments and assessments, hold office hours for 1.5 hours per week.}
    \work{Nozari Lab, Carnegie Mellon University}{Undergraduate Research Assistant}{Feb 2021 - Present}{Working with the JsPsych library to build and deploy a web-based linguistics experiment to investigate language production pipelines through the task of typing}{Project will move into the data analysis phase by April 2021}
    \work{Office Assistant}{Prime Medical Care, LLC}{June 2020 - August 2020}{Worked as an assistant in a doctor's office, managing scheduling, communications, and patient intake}{Gained experience with effective communication and patient treatment}{Automated multiple administrative office procedures, such as hours collection and billing tracking}
    \work{Taylor Lab, Princeton U. (Lab Learning Program)}{Research Assistant}{June 2019 - August 2019}{Used virtual reality simulations to evaluate the effects of 3D cues on depth perception}{Wrote custom scripts using R to conduct statistical analysis on over 12,000 trials}
